...
export const MobileNavbar: FC<{
    ...
    return (
        <div
            className={`${
                showMobNavbar ? 'scale-y-100' : 'scale-y-0'
            } origin-top transition-all duration-300 ease-in-out absolute top-0 left-0 right-0 bottom-0 w-full bg-white/90 h-screen flex flex-col`}
        >
            <svg
                onClick={() => mobNavbarHandler(false)}
